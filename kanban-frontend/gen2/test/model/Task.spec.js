...
(function(root, factory) {
  ...
  describe('Task', function() {
    it('should create an instance of Task', function() {
      ...
      //var instance = new FastApi.Task();
      //expect(instance).to.be.a(FastApi.Task);
    });
    ...
    it('should have the property columnId (base name: "column_id")', function() {
